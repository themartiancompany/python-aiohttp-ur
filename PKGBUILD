...
_gitcommit=996de2629ef6b4c2934a7c04dfd49d0950d4c43b
pkgver=3.8.6
pkgrel=1
...
arch=('x86_64')
license=('Apache')
depends=('python' 'python-multidict' 'python-async-timeout'
